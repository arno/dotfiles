...
globalkeys =
{
    ...
    key({ modkey, "Control" }, "Escape", awful.tag.history.restore),
...
table.insert(exitkeys, key({}, "l",
    function ()
        awesome.quit()
        remove_exitkeys()
    end))

table.insert(exitkeys, key({}, "r",
    function ()
...
table.insert(exitkeys, key({}, "Escape",
    function ()
...
clientkeys =
{
    key({ modkey,           }, "F11",    function (c) c.fullscreen = not c.fullscreen  end),
